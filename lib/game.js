(function () {
  ...
  Game.SNOWMAN_INTERVAL = 1000; //numSteps
  Game.EXTRA_LIFE_INTERVAL = 10000; //points

  Game.SNOWMAN_SPEED = .98; //higher value =1 means snowman moves with skiier
  Game.SUPER_SPEED = 1.6;
  ...
  Game.prototype.drawInstructions = function (ctx) {
    ctx.clearRect(0, 0, Game.DIM_X, Game.DIM_Y);
    image = new Image();
    image.src = 'images/instructions2.jpg';
